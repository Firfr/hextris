...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>如何玩</div><p>Hextris 的目标是阻止方块移出外层灰色六边形的内部区域。</p><p>" + (settings.platform != 'mobile' ? '按下右箭头键和左箭头键' : '点击屏幕的左侧和右侧') + " 来旋转六边形。" + (settings.platform != 'mobile' ? ' 按下下箭头键可以加速方块下落': '') + " </p><p>通过让 3 个或以上同色方块相连来清除方块并获得分数</p><p>你的连击持续时间还剩多少，由<span style='color:#f1c40f;'>这些</span><span style='color:#e74c3c'>彩色</span><span style='color:#3498db'>线条</span><span style='color:#2ecc71'>到</span>内层六边形的运动时间决定</p> <hr> <p id = 'afterhr'></p> 作者 <a href='http://loganengstrom.com' target='_blank'>Logan Engstrom</a> & <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a><br>在应用商店下载 <a href = 'https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'>iOS</a> & <a href ='https://play.google.com/store/apps/details?id=com.hextris.hextris' target='_blank'>Android</a><br>更多信息请访问方网站 <a href ='http://hextris.github.io/' target='_blank'>Hextris Website</a>");
	if (gameState == 1) {
		pause();
	}
